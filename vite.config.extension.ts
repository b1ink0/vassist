...
import {
  wrapContentScriptPlugin,
  copyAssetsPlugin,
} from "./tools/vite-plugins/extension-plugins";
      ...
      rollupOptions: {
        ...
        output: {
          ...
          manualChunks(id, { getModuleInfo }) {
            ...
            const isBackgroundDependency = moduleInfo?.importers?.some(
              (importer) => importer.includes("background/index.js"),
            );
