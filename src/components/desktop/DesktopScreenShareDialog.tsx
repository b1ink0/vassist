...
const DesktopScreenShareDialog = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#1a1a1a] text-white p-5 overflow-y-auto font-sans">
      ...
      {screens.length > 0 && (
        <div className="mb-6">
          <div className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wide">
            Screens
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-5">
            {screens.map((source) => (
              <div
                key={source.id}
                className={cn(
                  "glass-container rounded-lg p-3 cursor-pointer transition-all hover:scale-[1.02] hover:border-blue-400/50 flex flex-col gap-2.5",
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-sm font-medium text-white flex-1 truncate">
                    {source.name}
                  </div>
                </div>
              </div>
