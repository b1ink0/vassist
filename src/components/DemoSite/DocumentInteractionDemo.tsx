...
const DocumentInteractionDemo = ({
  ...
  const demoActions = [
    ...
    },
    {
      ...
      question:
        "Extract the weather forecast table data and summarize the weekly pattern",
    ...
    <section className="relative py-12 sm:py-16 px-3 sm:px-6">
      <div className="max-w-7xl mx-auto px-2 md:px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          >
            This page contains hidden content (tables, links, forms, code).
            Click "Try" to see how VAssist can extract it!
          </p>
        </div>
        ...
        <div className="mb-8 text-center flex flex-wrap justify-center gap-4">
          <button
            ...
            className={cn(
              "cursor-pointer px-6 py-2 md:py-3 rounded-lg font-semibold transition-all",
              isDark
          ...
          {demoActions.map((action, idx) => (
            ...
            >
              ...
              <button
                ...
                className={cn(
                  "cursor-pointer w-full px-2 md:px-4 py-2 rounded-lg font-semibold transition-all",
                  theme.ctaGradient,
        ...
        <div className={showHiddenContent ? "block" : "hidden"}>
          <div className={cn("p-6 sm:p-8", theme.card, "rounded-2xl")}>
            ...
            <div className="mb-8">
              <h4
                className={cn("text-xl font-semibold mb-4", theme.textPrimary)}
              >
                Weather Forecast
              </h4>
              <table
              ...
              >
                ...
                <tbody>
                  <tr
                    className={isDark ? "border-t border-white/10" : "border-t"}
                  >
            ...
            <div className="mb-8">
              ...
              <form className="space-y-3">
                <input
                  ...
                  placeholder="Name"
                  className={cn(
                    "w-full px-2 md:px-4 py-2 rounded",
                    isDark
            ...
            <div className="mb-8">
              ...
              <pre
                className={cn(
                  "p-2 md:p-4 rounded",
                  isDark ? "bg-black/30" : "bg-slate-900",
                  "overflow-x-auto",
                )}
              >
  ...
  return <input value={search} onChange={(e) => setSearch(e.target.value)} />;
            ...
            <div>
              ...
              <p className={theme.textSecondary}>
                AI assistants are revolutionizing web browsing. They can extract
                data, summarize content, and help with complex tasks without
                manual copy-pasting.
              </p>
            </div>
          </div>
