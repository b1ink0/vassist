...
const SetupWizard = () => {
  ...
  const getStepComponent = () => {
    switch (currentStep) {
      ...
      case 2: return <CharacterIntroStep />;
      case 3: return <LLMProviderStep />;
      case 4: return <TTSProviderStep />;
      case 5: return <AIFeaturesOverviewStep />;
      case 6: return <TutorialStep />;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full max-w-3xl h-[95vh] mx-2 sm:mx-4 flex flex-col">
        {/* Compact Header */}
        <div className="glass-container rounded-t-xl p-3 sm:p-4 flex-shrink-0">
          {/* Step indicator */}
          ...
          <div className="w-full h-1.5 bg-white/20 rounded-full overflow-hidden backdrop-blur-sm">
            <div
              className="h-full bg-gradient-to-r from-white/40 via-white/60 to-white/40 transition-all duration-500 ease-out shadow-[0_0_10px_rgba(255,255,255,0.5)]"
        ...
        <div 
          ref={contentRef}
          className="glass-container flex-1 overflow-y-auto p-4 sm:p-6" 
        ...
        <div className="glass-container rounded-b-xl p-3 sm:p-4 flex-shrink-0">
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              className="glass-button px-3 sm:px-4 py-2 rounded-lg text-sm font-medium bg-white/10 hover:bg-white/20 text-white transition-all flex items-center gap-1"
            >
