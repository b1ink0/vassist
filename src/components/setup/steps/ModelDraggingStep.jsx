...
const ModelDraggingStep = () => {
  ...
  return (
    <div className="setup-step model-dragging-step">
      <div className="step-header mb-8">
        <h2 className="text-3xl font-bold text-white mb-3">
          Model Dragging
        </h2>
        <p className="text-white/70 text-lg">
          Reposition your character anywhere on screen
        </p>
      </div>
      ...
      <div className="glass-container rounded-xl p-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white/5 rounded-xl border-2 border-dashed border-white/20 p-16 mb-8 text-center">
            ...
            <p className="text-white/30 text-sm mt-2">Model dragging demo will go here</p>
          </div>

          {/* Description */}
          <div className="space-y-4 text-white/80">
            <p className="text-lg">
              This section will show how to drag and reposition your character with animated demonstrations.
            </p>
            <ul className="list-disc list-inside space-y-2 text-white/70">
              <li>Click and drag to move character</li>
              <li>Character snaps to screen boundaries</li>
              <li>Position saves automatically</li>
              <li>Works in full-body mode</li>
            </ul>
          </div>
        </div>
      </div>
...
export default ModelDraggingStep;
