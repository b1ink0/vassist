  ...
  return (
    <div className={compact ? "space-y-2" : "space-y-4"}>
      {providers.map((provider) => {
        const available =
          provider.available !== undefined ? provider.available : true;
        ...
        return (
          ...
          >
            <div
              className={cn("flex items-start", compact ? "gap-2" : "gap-4")}
            >
              {/* Icon */}
              <div className="flex-shrink-0">
                {provider.iconName ? (
                  ...
                  <span
                    className={cn(compact ? "text-xl sm:text-2xl" : "text-4xl")}
                  >
                    {provider.icon}
                  </span>
                )}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  {provider.recommended && (
                    <Badge
                      variant="recommended"
                      className={
                        compact ? "text-[10px] px-1.5 py-0.5" : undefined
                      }
                    >
                      Recommended
                    </Badge>
                ...
                <p
                  className={cn(
                    compact ? "text-xs hidden sm:block" : "text-base",
                    mutedColor,
                    compact ? "mb-1" : "mb-3",
                  )}
                >
