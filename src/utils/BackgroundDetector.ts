...
class BackgroundDetector {
  private static instance: BackgroundDetector | null = null;
  private cachedUIConfig: typeof DefaultUIConfig = DefaultUIConfig;
   ...
   * @private
   */
  _calculateGradientBrightness(gradientString: string): number | null {
    try {
