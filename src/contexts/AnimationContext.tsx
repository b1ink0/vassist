...
export const AnimationProvider = ({ children }: AnimationProviderProps) => {
   ...
   */
  const getEnabledAnimations = useCallback(
    (category: string): EnabledAnimation[] => {
  ...
  const getRandomAnimation = useCallback(
    (category: string): EnabledAnimation | null => {
   ...
   */
  const toggleDefaultAnimation = useCallback(
    (animationId: string, isEnabled: boolean) => {
   ...
   */
  const toggleCustomAnimation = useCallback(
    async (motionId: string, category: string, isEnabled: boolean) => {
      try {
   ...
   */
  const hasEnabledAnimation = useCallback(
    (category: string) => {
